...
import com.newsparser.core.rewriter.RewriterService;
...
public class ParsersService {
    ...
    @Autowired
    public ParsersService(NewsArangoRepository arangoRepository, List<Parser> parsers, RewriterService rewriterService) {
